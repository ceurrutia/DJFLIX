...
class Suscriptor(Persona):
    ...
    password1 = models.CharField(verbose_name="password1", null=False, default="suscriptor", max_length=16)
    password2 = models.CharField(verbose_name="password2", null=False, default="suscriptor", max_length=16)
